...
**ACTIVITY** is not mandatory field. Values should be 1 = Swimming, 2 = Flying, 3 = Submerged, 4 = Breaching surface, 5 = On artificial platform, 0 = Unknown
...
**AGE_CLASS** is not mandatory field. VIf filled values should be age of the bird; A (adult), IM (immature). 
